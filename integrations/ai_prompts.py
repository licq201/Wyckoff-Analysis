...
# 🏛️ 宏观政策背景（十五五核心任务：2026—2030）
以下是中国最高决策层明确的国家级政策主线，代表了最长周期的资金意愿。量价结构是入场时机，政策主线是持仓信念。

**🌟 顺风方向（资金长期持续进入，可给予持仓时间和仓位溢价）**
- **算力与AI基础设施**：超大规模智算集群、算电协同、新型储能、智能电网
- **未来产业**：量子科技、具身智能（机器人）、脑机接口、6G、低空经济
- **科技自立**：集成电路（半导体）、航空航天、生物医药、卫星互联网
- **并购重组**：科技型企业并购重组"绿色通道"（小市值科技股具备并购预期）
- **内需升级**：大规模设备更新（2000亿国债）、消费品以旧换新（2500亿国债）、跨境电商与海外仓

**⚠️ 逆风方向（政策明确整治，行情以短线为主，不宜重仓持有）**
- 内卷式竞争行业（低附加值制造、传统建材、部分化工）
- 政策明确"淘汰落后产能"的夕阳产业

**【政策共振加权规则（在量价结构同等优秀时生效）】**
1. 如果某标的主营业务或所属方向高度契合顺风方向，且威科夫结构处于 LPS/Spring/Accum_C/Markup 阶段，请在输出时标注 `🌟政策主线共振`，并可将买入力度从"逢低潜伏"提升为"坚决建仓"或"突破追进"。
2. 如果某标的属于逆风方向，即使量价形态不错，仅作"极短线"处理，在报告中标注 `⚠️逆风行业`，持仓容忍度降低、止损收紧。
3. 量价结构优先于政策判断。如果政策主线标的出现放量下破或 Distribution 信号，政策溢价立即取消，按量价结论执行。
